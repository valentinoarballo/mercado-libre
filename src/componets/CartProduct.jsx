        ...
        return (
            <div className={hidden ? "hidden" : "border-b border-b-gray-200 flex justify-between items-center pb-10"}>
                ...
                <div className="flex items-center max-w-[8rem] border border-gray-200">
                    <button type="button" id="decrement-button" data-input-counter-decrement="quantity-input" onClick={() => { increaseDecreaseAmount(false) }} className="dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 p-3 h-11 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
                    ...
                    <button type="button" id="increment-button" data-input-counter-increment="quantity-input" onClick={() => { increaseDecreaseAmount(true) }} className="dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 -e-lg p-3 h-11 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
